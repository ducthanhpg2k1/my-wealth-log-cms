...
const SettingBanner = ({ form }: any) => {
  ...
  return (
    <div className={styles.container}>
      <Text type='font-18-600'>Manage record fields</Text>
      <div className={styles.content}>
        <Row gutter={16}>
          ...
          <Col span={5}>
            <Text type='font-14-400'>Image</Text>
          </Col>
          <Col span={2}>
            <Text className={styles.textRequired} type='font-14-400'>Required</Text>
          </Col>
        </Row>
